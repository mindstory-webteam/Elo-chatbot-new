...
class VectorStore:
    """FAISS vector store using the configured embeddings provider."""
    ...
    def initialize(self):
        ...
        try:
            ...
            # Initialize embeddings via the provider factory, so
            # EMBEDDINGS_PROVIDER is honoured. Local HuggingFace embeddings need
            # PyTorch and >512MB RAM; API-based providers (openai) do not, which
            # is what makes small free-tier hosts viable.
