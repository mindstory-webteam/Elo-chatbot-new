...
class HealthCheck(BaseModel):
    ...
    # Deprecated alias for `database`, kept so existing API clients keep working.
    mongodb: str = Field(..., description="Deprecated alias for `database`")
...
class SiteAppearanceConfig(BaseModel):
    ...
    primary_color: str = Field(default="#2745F8", description="Primary color (hex)")
    ...
    # White-label options
    hide_branding: bool = Field(default=False, description="Hide 'Powered by elo' branding")
    custom_branding_text: Optional[str] = Field(default=None, description="Custom branding text (replaces 'Powered by elo')")
...
class PlatformWhiteLabelConfig(BaseModel):
    ...
    app_name: str = Field(default="elo", description="Application name")
    ...
    primary_color: str = Field(default="#2745F8", description="Primary brand color")
    secondary_color: str = Field(default="#16a34a", description="Secondary brand color")
    login_title: str = Field(default="elo", description="Login page title")
    ...
    hide_elo_branding: bool = Field(default=False, description="Hide all elo branding")
...
class PlatformWhiteLabelUpdate(BaseModel):
    ...
    hide_elo_branding: Optional[bool] = None
