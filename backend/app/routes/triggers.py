...
async def get_site_triggers(
    ...
    triggers_data = await db.get_site_triggers(site_id)
...
async def create_trigger(
    ...
    saved_trigger = await db.save_trigger(site_id, trigger_dict)
...
async def set_global_cooldown(
    ...
    await db.set_global_cooldown(site_id, cooldown_ms)
...
async def update_trigger(
    ...
    updated_trigger = await db.update_trigger(site_id, trigger_id, updates)
...
async def delete_trigger(
    ...
    deleted = await db.delete_trigger(site_id, trigger_id)
...
async def reorder_triggers(
    ...
    success = await db.reorder_triggers(site_id, request.trigger_ids)
...
async def log_trigger_event(
    ...
    event_id = await db.log_trigger_event(
        site_id=site_id,
...
async def get_trigger_analytics(
    ...
    analytics = await db.get_trigger_analytics(site_id, period_days)
...
async def create_default_triggers(
    ...
    for trigger in default_triggers:
        saved = await db.save_trigger(site_id, trigger)
