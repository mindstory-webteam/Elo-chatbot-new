"""
Pytest configuration and fixtures for elo tests.
...
def test_settings() -> Settings:
    ...
    return Settings(
        ...
        POSTGRES_URL="postgresql://postgres:postgres@localhost:5432/elo_test",
...
async def app(mock_database: MockDatabaseProvider, mock_vector_store) -> AsyncGenerator[FastAPI, None]:
    ...
    with patch("app.database.get_database", get_mock_db), \
         patch("app.routes.sites.get_database", get_mock_db), \
         patch("app.routes.auth.get_database", get_mock_db), \
         patch("app.routes.embed.get_database", get_mock_db), \
         patch("app.routes.chat.get_database", get_mock_db), \
         patch("app.routes.conversations.get_database", get_mock_db), \
         patch("app.routes.handoff.get_database", get_mock_db), \
         patch("app.routes.triggers.get_database", get_mock_db), \
         patch("app.routes.crawl.get_database", get_mock_db), \
         patch("app.routes.analytics.get_database", get_mock_db), \
         patch("app.routes.leads.get_database", get_mock_db), \
