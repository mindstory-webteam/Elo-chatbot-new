/**
 * elo embeddable widget — source for build.js.
...
(function () {
  ...
  try {
    if (document.body && document.body.hasAttribute("data-elo-dashboard")) {
      return;
    }
  } catch (e) {}
  ...
  const embedFallback =
    ...
    window.__eloEmbed &&
    typeof window.__eloEmbed === "object"
      ? window.__eloEmbed
      : null;
  ...
  const config = {
    ...
    primaryColor: scriptEl?.dataset?.primaryColor || "#2745F8",
  ...
  function syncHeaderAndWelcomeText() {
    const G = document["querySelector"](".elo-header-text h3");
    if (G) G["textContent"] = config.title;
    const H = document["querySelector"](".elo-welcome h4"), I = document["querySelector"](".elo-welcome p");
    if (I) I["textContent"] = config.welcomeMessage;
  }
  function updateBrandingFooter() {
    const G = document["querySelector"](".elo-branding");
    if (!G) return;
    ...
    G["style"]["display"] = "block", H && (H["innerHTML"] = "Powered by <strong>elo</strong>", H["href"] = config.apiUrl, 
  ...
  const visitorBehavior = {
    ...
    loadVisitorData() {
      try {
        const G = localStorage["getItem"]("elo_visitor_" + config.siteId);
        if (G) {
    ...
    saveVisitorData() {
      try {
        localStorage["setItem"]("elo_visitor_" + config.siteId, JSON["stringify"]({
    ...
    loadShownTriggers() {
      try {
        const G = sessionStorage["getItem"]("elo_triggers_" + config.siteId);
        if (G) {
          const I = JSON["parse"](G);
          this["shownTriggerIds"] = new Set(I);
        }
        const H = localStorage["getItem"]("elo_visitor_triggers_" + config.siteId);
        if (H) {
    ...
    saveShownTrigger(G, H) {
      ...
      try {
        sessionStorage["setItem"]("elo_triggers_" + config.siteId, JSON["stringify"]([ ...this["shownTriggerIds"] ])), H && (this["visitorShownTriggerIds"]["add"](G), 
        localStorage["setItem"]("elo_visitor_triggers_" + config.siteId, JSON["stringify"]([ ...this["visitorShownTriggerIds"] ])));
      } catch (I) {}
    },
    checkTriggers() {
  ...
  function showNudge(G) {
    ...
    H["className"] = "elo-nudge", H["innerHTML"] = '\n      <div class="elo-nudge-message">' + escapeHtml(G["message"]) + '</div>\n      <button class="elo-nudge-close" aria-label="Dismiss">×</button>\n    ', 
    H["querySelector"](".elo-nudge-close")["addEventListener"]("click", I => {
      I["stopPropagation"](), H["classList"]["add"]("elo-nudge-out"), triggerEngine.logEvent(G["id"], "dismissed"), setTimeout(() => H["remove"](), 300), 
      activeNudgeEl = null;
  ...
  const handoff = {
    ...
    getAIConversation() {
      const G = messagesEl["querySelectorAll"](".elo-message-wrapper"), H = [];
      return G["forEach"](I => {
        const J = I["classList"]["contains"]("user"), K = I["querySelector"](".elo-message");
        K && H["push"]({
    ...
    showOfflineForm() {
      const G = '\n        <div class="elo-offline-form">\n          <div class="elo-offline-icon">\n            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n              <circle cx="12" cy="12" r="10"/>\n              <path d="M12 6v6l4 2"/>\n            </svg>\n          </div>\n          <h4>We\'re currently offline</h4>\n          <p>' + escapeHtml(handoffState.offlineMessage || "Leave your email and we'll get back to you.") + '</p>\n          <form class="elo-offline-email-form">\n            <input type="email" placeholder="Your email address" required class="elo-offline-email">\n            <button type="submit" class="elo-offline-submit">Send</button>\n          </form>\n        </div>\n      ', H = document["createElement"]("div");
      H["className"] = "elo-message-wrapper bot", H["innerHTML"] = '\n        <div class="elo-avatar bot">\n          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>\n            <circle cx="12" cy="7" r="4"/>\n          </svg>\n        </div>\n        <div class="elo-message-content">\n          <div class="elo-message bot">' + G + "</div>\n        </div>\n      ", 
      messagesEl["appendChild"](H), messagesEl["scrollTop"] = messagesEl["scrollHeight"];
      const I = H["querySelector"](".elo-offline-email-form");
      I["addEventListener"]("submit", async J => {
        J["preventDefault"]();
        const K = H["querySelector"](".elo-offline-email")["value"];
        try {
    ...
    updateUIForHandoff() {
      const G = document["querySelector"](".elo-header");
      if (G) {
        G["classList"]["add"]("handoff-mode");
        const I = G["querySelector"](".elo-header-text p");
        I && (I["textContent"] = handoffState.mode === "active" ? "Chatting with " + (handoffState.agentName || "Agent") : "Waiting for agent...");
      }
      const H = document["querySelector"](".elo-handoff-btn");
      H && (H["style"]["display"] = "none");
    },
    addSystemMessage(G) {
      const H = document["createElement"]("div");
      H["className"] = "elo-system-message", H["innerHTML"] = "<span>" + escapeHtml(G) + "</span>", messagesEl["appendChild"](H), messagesEl["scrollTop"] = messagesEl["scrollHeight"];
    },
    addAgentMessage(G, H) {
      const I = document["createElement"]("div");
      I["className"] = "elo-message-wrapper bot agent", I["innerHTML"] = '\n        <div class="elo-avatar bot agent">\n          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>\n            <circle cx="12" cy="7" r="4"/>\n          </svg>\n        </div>\n        <div class="elo-message-content">\n          <div class="elo-message bot">' + escapeHtml(G) + '</div>\n          <div class="elo-message-time">' + (H || "Agent") + " · " + (new Date)["toLocaleTimeString"]([], {
        hour: "2-digit",
        minute: "2-digit"
  ...
  widgetRoot["className"] = "elo-widget", widgetRoot["innerHTML"] = '\n    <button class="elo-toggle" aria-label="Toggle chat">\n      <svg class="elo-icon-chat" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n        <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2v10z"/>\n      </svg>\n      <svg class="elo-icon-close" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n        <line x1="18" y1="6" x2="6" y2="18"/>\n        <line x1="6" y1="6" x2="18" y2="18"/>\n      </svg>\n    </button>\n    \n    <div class="elo-window">\n      <div class="elo-header">\n        <div class="elo-header-icon">\n          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n            <path d="M12 2L2 7l10 5 10-5-10-5z"/>\n            <path d="M2 17l10 5 10-5"/>\n            <path d="M2 12l10 5 10-5"/>\n          </svg>\n        </div>\n        <div class="elo-header-text">\n          <h3>' + config.title + '</h3>\n          <p>Powered by AI</p>\n        </div>\n        <div class="elo-header-actions" style="display:flex;align-items:center;gap:8px;flex-shrink:0;">\n          <button type="button" class="elo-handoff-btn" title="Talk to a live agent" data-state="idle">\n            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">\n              <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/>\n              <circle cx="9" cy="7" r="4"/>\n              <path d="M23 21v-2a4 4 0 0 0-3-3.87"/>\n              <path d="M16 3.13a4 4 0 0 1 0 7.75"/>\n            </svg>\n            <span class="elo-live-agent-label">Live agent</span>\n          </button>\n          <button type="button" class="elo-header-close elo-close-btn" aria-label="Close chat">\n            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n              <line x1="18" y1="6" x2="6" y2="18"/>\n              <line x1="6" y1="6" x2="18" y2="18"/>\n            </svg>\n          </button>\n        </div>\n      </div>\n      \n      <div class="elo-messages">\n        <div class="elo-welcome">\n          <div class="elo-welcome-icon">\n            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">\n              <path d="M12 2L2 7l10 5 10-5-10-5z"/>\n              <path d="M2 17l10 5 10-5"/>\n              <path d="M2 12l10 5 10-5"/>\n            </svg>\n          </div>\n          <h4>Hi there! 👋</h4>\n          <p>I\'m your AI assistant. Ask me anything about this website.</p>\n          <div class="elo-welcome-suggestions">\n            <button class="elo-suggestion" data-query="What can you help me with?">What can you help me with?</button>\n            <button class="elo-suggestion" data-query="Tell me about this website">Tell me about this website</button>\n          </div>\n        </div>\n      </div>\n      \n      <div class="elo-input-wrapper">\n        <form class="elo-input-form">\n          <input type="text" class="elo-input" placeholder="Type your message..." autocomplete="off">\n          <button type="submit" class="elo-send" disabled>\n            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n              <line x1="22" y1="2" x2="11" y2="13"/>\n              <polygon points="22 2 15 22 11 13 2 9 22 2"/>\n            </svg>\n          </button>\n        </form>\n      </div>\n      \n      <div class="elo-branding">\n        <a href="'+ config.apiUrl +'" target="_blank" rel="noopener noreferrer">\n          Powered by <strong>elo</strong>\n        </a>\n      </div>\n    </div>\n  ', 
  document["body"]["appendChild"](widgetRoot), injectResponsiveStyles(), updateBrandingFooter();
  const toggleBtn = widgetRoot["querySelector"](".elo-toggle"),
    windowEl = widgetRoot["querySelector"](".elo-window"),
    messagesEl = widgetRoot["querySelector"](".elo-messages"),
    inputForm = widgetRoot["querySelector"](".elo-input-form"),
    inputEl = widgetRoot["querySelector"](".elo-input"),
    sendBtn = widgetRoot["querySelector"](".elo-send"),
    handoffBtn = widgetRoot["querySelector"](".elo-handoff-btn"),
    headerCloseBtn = widgetRoot["querySelector"](".elo-header-close");
  ...
  toggleBtn["addEventListener"]("click", () => {
    ...
    if (G["target"]["classList"]["contains"]("elo-suggestion")) {
    ...
    const H = G["target"]["closest"](".elo-feedback-btn");
    if (!H) return;
    const I = H["closest"](".elo-feedback"), J = parseInt(I["dataset"]["msgIndex"]), K = H["dataset"]["feedback"];
    I["querySelectorAll"](".elo-feedback-btn")["forEach"](L => {
    ...
    if (!welcomeRemoved) {
      const J = messagesEl["querySelector"](".elo-welcome");
      if (J) J["remove"]();
      welcomeRemoved = true;
    }
  ...
  function showHandoffSuggestion(G) {
    const H = document["createElement"]("div");
    H["className"] = "elo-handoff-suggestion", H["innerHTML"] = '\n      <p>Would you like to speak with a human agent?</p>\n      <div class="elo-handoff-suggestion-buttons">\n        <button class="elo-handoff-yes">Yes, connect me</button>\n        <button class="elo-handoff-no">No, thanks</button>\n      </div>\n    ', 
    H["querySelector"](".elo-handoff-yes")["addEventListener"]("click", () => {
      H["remove"](), handoff["requestHandoff"](G || "ai_suggested");
    }), H["querySelector"](".elo-handoff-no")["addEventListener"]("click", () => {
      H["remove"]();
    }), messagesEl["appendChild"](H), messagesEl["scrollTop"] = messagesEl["scrollHeight"];
  }
  function appendMessage(G, H, I = []) {
    ...
    K["className"] = "elo-message-wrapper " + H;
    const L = document["createElement"]("div");
    L["className"] = "elo-avatar " + H;
    H === "bot" ? L["innerHTML"] = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n        <path d="M12 2L2 7l10 5 10-5-10-5z"/>\n        <path d="M2 17l10 5 10-5"/>\n        <path d="M2 12l10 5 10-5"/>\n      </svg>' : L["textContent"] = "U";
    const M = document["createElement"]("div");
    M["className"] = "elo-message-content";
    const N = document["createElement"]("div");
    N["className"] = "elo-message " + H;
    let O = G;
    H === "bot" && (O = markdownToHtml(G));
    let P = O;
    config.showSources && I && I["length"] > 0 && (P += '\n        <div class="elo-sources">\n          <div class="elo-sources-label">\n            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n              <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/>\n              <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>\n            </svg>\n            Sources\n          </div>\n          <div class="elo-sources-list">\n            ' + I["map"](R => '\n              <a href="' + R["url"] + '" target="_blank" class="elo-source-link" title="' + R["url"] + '">\n                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n                  <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>\n                  <polyline points="15 3 21 3 21 9"/>\n                  <line x1="10" y1="14" x2="21" y2="3"/>\n                </svg>\n                ' + (R["title"] || "Source") + "\n              </a>\n            ")["join"]("") + "\n          </div>\n        </div>\n      ");
    N["innerHTML"] = P, M["appendChild"](N);
    const Q = document["createElement"]("div");
    Q["className"] = "elo-message-time", Q["textContent"] = (new Date)["toLocaleTimeString"]([], {
      hour: "2-digit",
      minute: "2-digit"
    }), M["appendChild"](Q);
    if (H === "bot") {
      const R = document["createElement"]("div");
      R["className"] = "elo-feedback", R["dataset"]["msgIndex"] = msgIndex, R["innerHTML"] = '\n        <button class="elo-feedback-btn" data-feedback="positive" title="Helpful">\n          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n            <path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"/>\n          </svg>\n        </button>\n        <button class="elo-feedback-btn" data-feedback="negative" title="Not helpful">\n          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n            <path d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3zm7-13h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17"/>\n          </svg>\n        </button>\n      ', 
      M["appendChild"](R);
    }
  ...
  function showTypingIndicator() {
    ...
    G["className"] = "elo-typing-wrapper";
    const H = document["createElement"]("div");
    H["className"] = "elo-avatar bot", H["innerHTML"] = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\n      <path d="M12 2L2 7l10 5 10-5-10-5z"/>\n      <path d="M2 17l10 5 10-5"/>\n      <path d="M2 12l10 5 10-5"/>\n    </svg>';
    const I = document["createElement"]("div");
    return I["className"] = "elo-typing", I["innerHTML"] = "<span></span><span></span><span></span>", G["appendChild"](H), 
